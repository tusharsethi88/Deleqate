  ...
  return (
    <AuthShell footerLinks={false}>
      <div style={{ display: 'flex', justifyContent: 'center', margin: '1rem 0' }}>
        <i data-lucide="key" style={{ width: 32, height: 32, color: 'var(--navy)' }}></i>
      </div>
      ...
      <div style={{ textAlign: 'center' }}>
        {role === 'pilot'
          ? <span className="role-badge pilot" style={{ display: 'inline-flex', alignItems: 'center' }}><i data-lucide="rocket" style={{ width: 13, height: 13, marginRight: 5 }}></i> AI Pilot</span>
          : <span className="role-badge client" style={{ display: 'inline-flex', alignItems: 'center' }}><i data-lucide="sparkles" style={{ width: 13, height: 13, marginRight: 5 }}></i> Customer</span>}
      </div>
      ...
      <form onSubmit={submit}>
        ...
        <button type="submit" disabled={busy} className="btn btn-full"
          style={{ marginTop: '1.25rem', background: role === 'pilot' ? '#4F46E5' : 'var(--gold)', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px' }}>
          Send Reset Code <i data-lucide="arrow-right" style={{ width: 14, height: 14 }}></i>
        </button>
      </form>
