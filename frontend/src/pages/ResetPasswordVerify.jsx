    ...
    <AuthShell footerLinks={false} backHome={false}>
      <div style={{ textAlign: 'center' }}>
        <div style={{ display: 'flex', justifyContent: 'center', margin: '1rem 0' }}>
          <i data-lucide="mail" style={{ width: 32, height: 32, color: 'var(--navy)' }}></i>
        </div>
        ...
        <form onSubmit={submit}>
          ...
          <button type="submit" disabled={busy || otp.length < 6} className="btn btn-primary btn-full" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: '6px' }}>Verify Code <i data-lucide="arrow-right" style={{ width: 14, height: 14 }}></i></button>
        </form>
        <p style={{ marginTop: '1.25rem', fontSize: '0.8.rem', color: 'var(--gray-400)' }}>
